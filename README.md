...
**Matriculas y nombres**: (Incluye aquí las matrículas y nombres de las personas que trabajadonr en el documento)
...
| :--- | :--- | :--- |
| **1** | "El sistema debe ser capaz de manejar a **muchos** usuarios al mismo tiempo." | **Específico:** Sustituir "muchos" por una cifra de usuarios concurrentes. **Requerimiento refactorizado**: |
| **2** | "La interfaz debe ser amigable e intuitiva para **varios** tipos de personas." | **Medible:** Definir una métrica objetiva de éxito o prueba de usuario. **Requerimiento refactorizado**: |
| **3** | "El software se terminará lo más pronto posible para cumplir con el cliente." | **Limitado en el tiempo:** Definir un plazo o fecha límite específica. **Requerimiento refactorizado**: |
| **4** | "La base de datos deberá guardar el historial de ventas, clientes, **etcétera**." | **Específico:** Listar todos los elementos; evitar el uso de "etcétera". **Requerimiento refactorizado**: |
| **5** | "El sistema debe funcionar con un 100% de disponibilidad sin errores." | **Alcanzable:** Ajustar a un nivel de disponibilidad técnicamente factible. **Requerimiento refactorizado**: |
| **6** | "Se requiere que el sistema envíe **algunos** correos de notificación al administrador." | **Específico:** Definir los eventos exactos que disparan la notificación. **Requerimiento refactorizado**: |
| **7** | "El módulo de contabilidad debe estar listo para usarse algún día." | **Limitado en el tiempo:** Establecer una fecha para priorizar y programar la tarea. **Requerimiento refactorizado**: |
| **8** | "La aplicación debe ser rápida, cargando los reportes en un instante." | **Medible:** Definir el tiempo de carga en segundos o milisegundos. **Requerimiento refactorizado**: |
| **9** | "El sistema debe incluir un juego de naves para que los empleados se distraigan." | **Relevante:** Evaluar si contribuye a los objetivos generales del proyecto. **Requerimiento refactorizado**: |
| **10** | "El software debe ser escalable de forma automática y global." | **Rastreable/Alcanzable:** Asegurar que sea factible económica y operativamente.  **Requerimiento refactorizado**: |
